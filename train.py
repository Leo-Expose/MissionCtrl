...
HF_REPO         = "your-hf-username/missionctrl-overseer"  # set before push
...
- FLAG_HALLUCINATION(task_id, "evidence")   — flag a corrupted output with specific evidence
